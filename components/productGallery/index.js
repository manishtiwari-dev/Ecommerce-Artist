...
const index = (slug) => {
  ...
  const getData = async (pagev) => {
    ...
    POST(ProductTypeUrl, filterData)
      .then((response) => {
  ...
  const title = `${typeName}${TitleSuffix}`;
  ...
  const onSubmit = async (formData) => {
    ...
    saveFormData.product_type = slugData;
          ...
          <div className="row">
            <div className="col-md-3">
              <form onSubmit={handleSubmit(onSubmit)}>
                {/* <input type="hidden" value={catList && catList.slug}   {...register("category")}  /> */}
                <div className="col-left">
                  <div className="header-row">
                    {typeData && <h1>{typeData.type_name}</h1>}
                    <button
                      type="button"
                      onClick={handleClick}
                          ...
                          {productdata && productdata.length > 0 ? (
                            productdata.map((item, index) => (
                              <div className="column">
                                <div className="imasonry-items" onClick={console.log('item', item)} >
