...
const ArtistDashboard = () => {
	...
	// function runScritp() {
	// 	$('.tabber-content').hide();
	// 	$('.tabber-content:first').show();
	// 	$('.tabber-list a').click(function () {
	// 		var tab = $(this).attr('href');
	// 		$(this).parent().addClass('active').siblings().removeClass('active');
	// 		$('.tabber-content').hide().removeClass('active');
				...
				<div className="container-fluid">
					<div className="row">
						...
						<div className="col-md-6">
							<div className="list">
								<ul>
									<li className="Pending">(4) Pending Approval</li>
									<li className="Order">(7) Recent Orders</li>
									<li>
						...
						<div className="tabber-wrapper">
							<div className="tabber">
								<ul className="tabber-list">
									<li>
										<a onClick={() => setActiveTab('tab1')}>Dashboard</a>
									</li>
									<li>
										<a onClick={() => setActiveTab('tab2')}>Artwork</a>
									</li>
									<li>
										<a onClick={() => setActiveTab('tab3')}>Profile Setting</a>
									</li>
								</ul>
							</div>
									...
									<div className="tabber-content" id="tab3">
										<div className="row">
											...
											<div className="d-flex mb-4">
												<button
													type="submit"
													className="btn btn-primary savechangesBtn"
												>
													Save Changes
												</button>
											</div>
